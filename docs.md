...
> [!NOTE]
> All of the following functions can be used with any type of enum. See more functions [here](https://pkg.go.dev/github.com/xybor-x/enum#pkg-functions).
...
You can also utilize the underlying enum of `WrapEnum`s or `SafeEnum` for:
